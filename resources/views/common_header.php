    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="/common" class="nav-link">Home</a>
          </li>
          
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Chart</a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="/common_chartph" class="dropdown-item">PH </a></li>
              <li><a href="/common_chartorp" class="dropdown-item">ORP</a></li>
              <li><a href="/common_charttem" class="dropdown-item">Temperature</a></li>
              <li><a href="/common_chartch" class="dropdown-item">Chlorine</a></li>
              <li><a href="/common_chartch_t" class="dropdown-item">Chlorine_total</a></li>
              <li><a href="/common_chartch_c" class="dropdown-item">Chlorine_comb</a></li>
