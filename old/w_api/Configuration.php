...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '55fa25738f748bbf454396db526173f396777202e6ad4d35dfc64086372ea8a0';
	const ERROR_REPORTING_LEVEL = 0;
	const DEPLOYED_HOSTNAME = 'mypooldata.com.au';
	const BUILDDATE = 1578384249;
